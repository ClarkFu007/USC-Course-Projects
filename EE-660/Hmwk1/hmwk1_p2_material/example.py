...
def display(w, Xtest, Ytest, norm, levels=None,
...
def main():
	...
	Xtrain, Ytrain, Xtest, Ytest = dataset['X_train'], dataset['y_train'], \
	...
	# for l1 results
	w = [2.91, 1.37, 2.]
	display(w=w, Xtest=Xtrain, Ytest=Ytrain, norm='l1')
	# for l2 results
	w = [2.3,  1.39, 1.88]
	display(w=w, Xtest=Xtrain, Ytest=Ytrain, norm='l2')
	plt.show()
	return
