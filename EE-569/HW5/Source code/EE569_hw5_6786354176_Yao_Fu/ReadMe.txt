...
========================================================================
    CONSOLE APPLICATION : [EE569_hw5_6786354176_Yao Fu] Project Overview
========================================================================

This file contains a summary of what I will find in each of the files that
make up my [EE569_hw5_6786354176_Yao Fu] application.

Steps:

1. Open "EE569_hw5_6786354176_Yao_Fu_Python.py".
...
2. Run the section "def main()".
   ...
   Step2: While running the function "net_accuracy_demo(train_data, train_label, test_data, test_label,
                                      ini_name, i, learning_rate, decay_value)", you can modify the parameters setting
	                "initializer"
                        "learning rate"
                        "decay"
in order to achieve different training tasks.


   Step3: The function "def creat_net(train_data, class_num, ini_name)" is to build the convolutional neural network derived from
the LeNet-5.
