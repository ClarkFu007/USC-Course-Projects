...
% USC ID: 6786354176
% Email: yaof@usc.edu
% Goal: The function to do the geometric warping

function output_img=geo_warping(input_img,height,width)

% Transform the input image 512 by 512 into 513 by 513
...
% Get the location of the center pixel of the input image
m_center=height/2+1;      % The value of the row of the center 
n_center=width/2+1;       % The value of the column of the center

% Do the geometric warping in the polar coordinate system
...
for m=1:1:m_center
    for n=1:1:n_center
        ...
        n_C=floor(m_center-(m_center-n)/m_center*row_pixel_num_C(m))+1;
