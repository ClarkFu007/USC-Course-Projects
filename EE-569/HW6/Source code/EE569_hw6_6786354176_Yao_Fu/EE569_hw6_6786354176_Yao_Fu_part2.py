...
# train_test_split(TrainData, TrainLabel, test_size=1-0.1, stratify=TrainLabel)
...
(Final_output0, Final_output_test0) = \
    extract_feature(re_output0, re_output0_test, 1750, TrainLabel1)  # Train label might change
print("Feature_ce0:", Final_output0.shape)
print("Final_output_test0:", Final_output_test0.shape)

(Final_output1, Final_output_test1) = \
    extract_feature(re_output1, re_output1_test, 1000, TrainLabel1)  # Train label might change
print("Feature_ce1:", Final_output1.shape)
print("Final_output_test1:", Final_output_test1.shape)

(Final_output2, Final_output_test2) = \
    extract_feature(re_output2, re_output2_test, 250, TrainLabel1)  # Train label might change
